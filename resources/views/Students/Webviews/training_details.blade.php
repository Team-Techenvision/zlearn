                        ...
                        <form class="form-group col-md-10 m-auto" action="{{url('Training-Info')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">                                
                                <div class="col-12 col-md-12 mb-3">
                                    <label class="form-label text-uppercase" for="">TECHNICAL SKILLS:</label>                                     
                                     <textarea class="form-control" name="tech_skill" placeholder="Enter Technical Skill" required=""></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                 <div class="col-12 col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="" placeholder="Enter Linkedin Profile Link" name="linkedin_link">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-12 col-md-6 mb-3">
                                    <label class="form-label text-uppercase" for="">ACHIEVEMENTS:</label>
                                    <input type="text" class="form-control" id="" placeholder="Enter Achievements If Any" name="achievement">
                                </div>
                                <div class="col-12 col-md-6 mb-3">
                                    <label class="form-label text-uppercase" for="">HOBBIES:</label>
                                    <input type="text" class="form-control" id="" placeholder="Enter Your Hobbies" name="hobbies">
                                </div>
                            </div>
                            ...
                            <div class="form-row">                                 
                                <div class="col-12 col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control" id="" placeholder="Enter Career Objective" name="career_object"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
