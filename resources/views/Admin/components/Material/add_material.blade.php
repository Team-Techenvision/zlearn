                        ...
                        <div class="col-md-9">
                            <div class="row">
                                ...
                                <div class="form-check mb-2 col-6">
                                    <input class="form-check-input" type="radio"  name="attachment_type" id="exampleRadios1" value="1" checked>
                                    <label class="form-check-label" for="exampleRadios1">
                                       PDF
                                    </label>
                                </div>
                                <div class="form-check col-6">
                                    <input class="form-check-input" type="radio"  name="attachment_type" id="exampleRadios2" value="0">
