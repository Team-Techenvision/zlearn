        ...
        <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap text-center" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{url('edit-test/'.$row->id)}}" class="btn btn-info mr-2">Edit</a> @if($row->status == 1) <a href="{{url('delete-test/'.$row->id)}}" class="btn btn-danger">Deactive</a>@else <a href="{{url('delete-test/'.$row->id)}}" class="btn btn-info">Active</a>@endif </td>                                               
                    </tr>
                    @endforeach
